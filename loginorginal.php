...
// Make sure to use the same project path across all files
$project_base_path = '/CloudAssignment/'; // Adjust this to match your actual path
...
// Calculate base URL the same way header.php does
